...
public class ScreenShotMaker : MonoBehaviour
{
    ...
    {
        UnityEngine.Debug.Log("Initializing camera and stuff...");
        ...
        UnityEngine.Debug.Log("Initialized successfully!");
        UnityEngine.Debug.Log("Computing level boundaries...");
        ...
        if (target != null)
        {
            ...
            {
                UnityEngine.Debug.Log("Unfortunately no boundaries could be found :/");
                return;
            }
        ...
        UnityEngine.Debug.Log("Boundaries computed successfuly! The computed boundaries are " + bounds);
        UnityEngine.Debug.Log("Computing target image resolution and final setup...");
        ...
        UnityEngine.Debug.Log("Success! Everything seems ready to render!");
        ...
        for (float i = bounds.w, xPos = 0; i < bounds.x; i += renderCamera.aspect * renderCamera.orthographicSize * 2, xPos++)
        {
            for (float j = bounds.y, yPos = 0; j < bounds.z; j += renderCamera.aspect * renderCamera.orthographicSize * 2, yPos++)
            {
                ...
                UnityEngine.Debug.Log("Rendered and copied chunk " + (xPos + 1) + ":" + (yPos + 1));
            }
        }

        UnityEngine.Debug.Log("All chunks rendered! Some final adjustments and picture should be saved!");
        ...
        UnityEngine.Debug.Log("All done! Always happy to help you :)");
    }
}